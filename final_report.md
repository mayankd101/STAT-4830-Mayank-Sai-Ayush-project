...
The project additionally incorporated torch.compile for graph-level optimization and kernel fusion.


Compiler optimizations reduced Python overhead and improved:
...
particularly during repeated transformer operations.


---


## 4.6 Mixup and Label Smoothing


To improve generalization and optimization stability, the project implemented:
...
Label smoothing modifies hard targets:
...
These methods improved optimization smoothness and reduced overconfidence.
...
The project also explored a custom optimizer inspired by modded-nanoGPT called Muon.
...
specifically to transformer weight matrices.


The intuition was that orthogonalized updates may provide more stable optimization directions for transformer layers.


Two-dimensional transformer matrices used Muon updates, while:
...
continued using AdamW.


---


## 4.8 Average Pooling Head


The project replaced the standard CLS token classification head with global average pooling over patch representations.
...
This reduced parameter overhead and improved convergence stability on smaller datasets.


---


## 4.9 Results of Systems Optimization
